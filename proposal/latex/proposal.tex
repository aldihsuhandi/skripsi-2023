...
Ruang lingkup dari proyek perancangan sebuah aplikasi \textit{marketplace} terfokus untuk hobi dengan fitur utama sebuah filter terhadap tingkat kemahiran sebuah hobi, untuk menghindari pembahasan dan implementasi yang meluas dan supaya lebih terfokus maka ditetapkan batasan-batasan atau ruang lingkup sebagai berikut:
\begin{enumerate}
    \item Aplikasi hanya berbasis dan berada dalam bentuk aplikasi website dan tidak ada versi \textit{mobile}.
    ...
    \item \textit{Database} menggunakan \textit{mysql}.
\end{enumerate}
...
Manfaat yang diharapkan didapatkan dari proyek ini adalah untuk aplikasi yang dirancang dapat:
\begin{enumerate}
