...
\begin{enumerate}
    ...
    \item Bagaimana merancang dan membuat sebuah aplikasi \textit{marketplace} hobi berbasis \textit{web} dengan memiliki tampilan yang simpel dan mudah digunakan oleh semua kalangan \textit{user}
    \item Bagaimana merancang dan membuat sebuah fitur saring \textit{Interest Level} atau fitur Tingkat Peminatan yang cocok dan dapat berjalan dengan baik untuk setiap barang yang akan dijual disana
    \item Bagaimana merancang dan membuat sebuah sistem diskusi forum yang cocok dengan barang hobi yang dijual pada aplikasi \textit{web} ini dan dapat dengan mudah digunakan oleh para \textit{user} untuk berdiskusi mengenai barang-barang hobi tersebut
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Fitur selain itu fitur utama tempat diskusi forum, seperti membaca, membuat dan membalas post dan komentar.
    \item Dalam membangun \textit{Front-End} bahasa yang digunakan adalah \textit{Javascript} dan \textit{Framework} / \textit{Library} yang digunakkan adalah yang berbasis \textit{React}.
...
\begin{enumerate}
    ...
    \item Merancang dan membuat sebuah aplikasi \textit{marketplace} hobi berbasis \textit{web} dengan memiliki tampilan yang simpel dan mudah digunakan oleh semua kalangan pengguna.
    \item Merancang dan membuat sebuah fitur saring \textit{Interest Level} atau fitur Tingkat Peminatan yang cocok dan dapat berjalan dengan baik untuk setiap barang yang akan dijual disana.
    \item Merancang dan membuat sebuah sistem diskusi forum yang cocok dengan barang hobi yang dijual pada aplikasi \textit{web} ini dan dapat dengan mudah digunakan oleh para pengguna untuk berdiskusi mengenai barang-barang hobi tersebut.
\end{enumerate}
