...
Tujuan dari proyek ini adalah untuk membuat sebuah aplikasi untuk \textit{marketplace} untuk jual/beli barang hobi. Yang memiliki manfaat, mempermudah pengguna pembeli untuk mencari barang hobi yang cocok. Mempermudah penjual dalam mempromosikan barang-nya kepada pelanggan dengan fitur filter \textit{Interest Level}. Menyediakan sarana diskusi mengenai hobi melewati forum.
