...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        Aplikasi \textit{ShumiShumi} memenuhi aturan emas yang keempat ini. Dimana dalam proses aksi ketika sudah selesai ada sebuah respons dari aplikasi yang menandakan dan memberitahu kepada pengguna bahwa proses tersebt sudah selesai. Dapat di contohkan dengan proses memperbaharui profil yang memiliki respons bahwa profil selesai dan berhasil di perbarui dan juga proses transaksi yang di halaman transaksi akan ada informasi dimana transaksi tersebut telah selesai yang ditandakan dengan status "Done".
