...
\end{table}
    ...
    \begin{itemize}
        ...
        \begin{longtable}{|l|l|l|l|}
            ...
            8 & gender & varchar(255) & \textit{field} untuk menampung gender \textit{user} \\ \hline
            9 & date\_of\_birth & timestamp & \textit{field} untuk menampung tanggal lahir \textit{user} \\ \hline
            10 & location & varchar(255) & \textit{field} untuk menampung lokasi tempat tinggal \textit{user} dalam bentuk json\\ \hline
            11 & profile\_picture & varchar(255) & \textit{field} untuk menampung gambar profil \textit{user}\\ \hline
            12 & review & double & \textit{field} untuk menampung \textit{review} yang diberikan kepada \textit{user}\\ \hline
            13 & is\_active & boolean & \textit{field} yang menandakan apakah \textit{user} sudah aktif atau belum\\ \hline
            14 & is\_deleted & boolean & \textit{field} yang menandakan apakah \textit{user} sudah di\textit{delete} atau belum\\ \hline
        \end{longtable}
