...
\begin{enumerate}
    ...
    \item Bagaimana merancang sebuah aplikasi \textit{marketplace} hobi yang dapat membantu penjual atau \textit{seller} dalam mempromosikan barang hobi yang mereka jual
    \item Bagaimana merancang fitur \textit{interest level} untuk membantu pencarian barang hobi yang tepat
    \item Bagaimana merancang fitur utama sistem rekomendasi untuk membantu penjual mempromosikan barangnya dengan rekomendasi barang hobi ke \textit{user} yang tepat
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Merancang dan membuat sebuah aplikasi \textit{marketplace} hobi yang dapat membantu penjual atau \textit{seller} dalam mempromosikan barang hobi yang mereka jual
    \item Merancang dan membuat fitur \textit{interest level} untuk membantu pencarian barang hobi yang tepat
    \item Merancang dan membuat fitur utama sistem rekomendasi untuk membantu penjual mempromosikan barangnya dengan rekomendasi barang hobi ke \textit{user} yang tepat
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Menyediakan tempat promosi yang tepat untuk penjual barang hobi, dimana promosi barang dibantu dengan sistem rekomendasi
\end{enumerate}
