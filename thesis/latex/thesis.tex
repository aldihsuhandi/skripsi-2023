...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        Untuk aturan emas kedua ini, aplikasi \textit{ShumiShumi} ini memiliki fitur yang cocok yaitu dengan \textit{font} yang mudah dibaca, \textit{responsive} sehingga bisa diakses dan digunakkan di perangkat yang kecil dan warna yang tidak tabrakan.
        ...
        Aplikasi \textit{ShumiShumi} memenuhi aturan emas yang keempat ini, dimana dalam proses aksi ketika sudah selesai ada sebuah respons dari aplikasi yang menandakan dan memberitahu kepada pengguna bahwa proses tersebut sudah selesai. Dapat dicontohkan dengan proses memperbaharui profil yang memiliki respons bahwa profil selesai dan berhasil di perbarui dan juga proses transaksi yang di halaman transaksi akan ada informasi dimana transaksi tersebut telah selesai yang ditandakan dengan status "Done".
