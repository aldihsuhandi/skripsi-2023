...
\subbab{2.1.6 Internet}
Internet merupakan sebuah bentuk dari infrastruktur jaringan global yang menghubungkan miliaran komputer (ataupun perangkat lainnya) di seluruh dunia satu sama lain dan ke \textit{World Wide Web}\autocite{javatpoint-internet}. Internet dibangun/di-\textit{setup} dengan menggunakan bantuan transmisi data dari kabel-kabel \textit{fiber optic} atau kabel tembaga dan berbagai macam media jaringan lainnya. Bahkan, untuk mengakses internet melalui layanan seperti 2G, 3G dan 4G atau Wifi, pengaturan fisik dari kabel-kabel jaringan tersebut masih diperlukan\autocite{gfg-internet}. 
WIP

\subbab{2.1.7 \textit{API Call}}
WIP
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \textbf{Representasi Grafis}:\\
        \includegraphics[scale=0.5]{class diagram generalization example.png}
    ...
    \begin{itemize}
        ...
        \includegraphics[scale=0.5]{multiplicity multiple disjoint ranges example.png}\\
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Biasanya diberikan label yang berisikan nama atau dari individu atau objek yang bertanggung jawab\autocite{systemanalysisdesign-activity-diagram}\\
                  Contoh gambar:\\
                  \includegraphics[scale=0.5]{Swimlane_transparent.png}
        \end{itemize}
    \end{itemize}
    \item \textit{Use-Case Diagram}\\
    \textit{Use-Case Diagram} merupakan salah satu jenis diagram UML yang digunakan untuk menentukan konteks dan \textit{requirements} dari sebuah sistem serta memvalidasi bentuk arsitektur dari sebuah sistem yang digambarkan dengan mengimplementasikan satu atau beberapa \textit{test case}. 
