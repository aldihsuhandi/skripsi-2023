          ...
          \begin{enumerate}
              \item \textit{Back end}
                    ...
                    \begin{enumerate}
                        ...
                        \textit{Logback} adalah \textit{project successor} ke \textit{logging project log4j}, \textit{logback} adalah \textit{logging framework} yang cepat, simple dan kapabel sebagai \textit{logging framework} untuk aplikasi \textit{enterprise}\autocite{logback}.
