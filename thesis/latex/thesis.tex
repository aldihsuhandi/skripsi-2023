...
\begin{enumerate}
    ...
    \item Bagaimana merancang sebuah aplikasi \textit{marketplace} hobi yang dapat membantu penjual atau \textit{seller} dalam mengiklankan barang hobi yang mereka jual dengan fitur utama sistem rekomendasi ke \textit{user} yang tepat
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Merancang dan membuat sebuah aplikasi \textit{marketplace} hobi yang dapat membantu penjual atau \textit{seller} dalam mengiklankan barang hobi yang mereka jual dengan fitur utama sistem rekomendasi ke \textit{user} yang tepat
\end{enumerate}
...
\begin{enumerate}
    ...
    Waktu yang diperlukan oleh sebuah pengguna untuk mempelajari cara menggunakan dan navigasi sebuah aplikasi.
    \item \textit{Speed of task performance}\\
    Seberapa cepat sebuah pengguna dalam melaksanakan sampai selesai suatu fungsi sampai selesai.
    ...
    Pengukuran seberapa puas pengguna dari aspek manapun sebuah aplikasi.
\end{enumerate}
...
\begin{enumerate}
    ...
    Penambahan fitur untuk segala macam pengguna, seperti fitur untuk membantu pemula dalam teknologi seperti penjelasan atau fitur untuk yang ahli supaya dapat lebih shortcuts untuk mempercepat penggunaan akan mendorong rasa kualitas.
    ...
    Poin berfokus kepada agak pengguna dijaga dari sistem supaya tidak dapat melakukan \textit{error} yang serius, dan jika terjadi \textit{error} pada tinggi tingkat manapun harus ada panduan dari aplikasi yang mudah dimengerti, konstruktif dan spesifik untuk membetulkannya.
