...
Metode penelitian yang digunakan pada penelitian ini adalah metode penelitian kuantitatif yang bersifat deskriptif dengan melakukan analisis dari hasil pengumpulan data yang dilakukan\autocite{metode-kuantitatif}.


Untuk proses Pengumpulan data yang dilakukan adalah dengan membuat form survei menggunakan \textit{Google Form} untuk mendapatkan pendapat atas pertanyaan-pertanyaan yang terkait dengan alasan dari pembuatan aplikasi pada penelitian ini. Dari hal mengenai pembelian barang hobi hingga tingkat kesulitan dalam menemukan barang yang cocok. Dari semua jawaban survei yang dikumpulkan tersebutlah, dapat memperoleh gambaran dan konfirmasi atas fitur-fitur yang penelitian ini butuhkan.
...
Metode pengumpulan data yang dilakukan adalah dengan membuat sebuah form survei menggunakan \textit{Google Form} untuk mendapatkan pendapat atas pertanyaan-pertanyaan yang terkait dengan alasan dari pembuatan aplikasi pada penelitian ini. Survei

Dari hal mengenai pembelian barang hobi hingga tingkat kesulitan dalam menemukan barang yang cocok. Dari semua jawaban survei yang dikumpulkan tersebutlah, dapat memperoleh gambaran dan konfirmasi atas fitur-fitur yang proyek ini butuhkan.
...
\subbab{3.2 Analisis}
\subsubbab{3.2.1 Analisis sistem yang berjalan atau perbandingan aplikasi sejenis}
