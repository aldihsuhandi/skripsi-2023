...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \textit{Multiplicity} merupakan sebuah bentuk untuk mendokumentasikan bagaimana sebuah \textit{instance} dari sebuah objek/\textit{class} dapat diasosiasikan dengan \textit{instance} lainnya. Biasanya dituliskan sebagai angka dalam bentuk format "angka minimum... angka maksimum"\autocite{uml-satzinger-class-diagram}. 
            \newpage
            \begin{figure}[h]
                \centering
