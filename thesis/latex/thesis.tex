...
\begin{centering}
\captionof{table}{Tabel perbandingan fitur antara \textit{ShumiShumi} dengan aplikasi pada penelitian terdahulu (1)}
...
\begin{centering}
\captionof{table}{Tabel perbandingan fitur antara \textit{ShumiShumi} dengan aplikasi pada penelitian terdahulu (2)}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        Aplikasi \textit{ShumiShumi} dianggap sudah memenuhi aturan emas yang ketiga ini, aplikasi \textit{ShumiShumi} akan memberikan ataupun menampilkan informasi kepada penggunanya untuk setiap aksi yang telah dilakukannya. Seperti contoh, saat pengguna memasukan barang kedalam \textit{wishlist} akan memunculkan notifikasi diatas yang mengabarkan status proses tersebut apakah berhasil atau gagal.
        ...
        Aplikasi \textit{ShumiShumi} ini memenuhi aturan ini dengan fiturnya dimana pengguna dengan mudah dapat melakukan perbahuan informasi personal, mengatur \textit{cart} dan \textit{wishlist} sendiri dan juga mencari dan filter barang.
