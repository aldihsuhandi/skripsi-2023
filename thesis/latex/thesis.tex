...
\textit{Code Transformation} yang dimaksud adalah perubahan kode yang perlu dilakukan untuk merubah kode sebuah aplikasi dari \textit{development} untuk lebih cocok dan mudah untuk ke tahap \textit{production}\autocite{Nextjs_compiler}. Perubahan yang dilakukan adalah:
...
\begin{itemize}
    ...
    Dengan \textit{bundling} tersebut maka halaman akan hanya memuat dan memproses kode yang diperlukan sehingga mempercepat waktu membuka halaman tersebut\autocite{Nextjs_code_splitting}.
\end{itemize}
