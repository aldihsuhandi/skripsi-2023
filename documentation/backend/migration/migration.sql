...
VALUES
    ...
    (
        "OTP_EMAIL",
        '<body style="background-color:#d8dee9"><table align="center" border="0" cellpadding="0" cellspacing="0" width="800" bgcolor="white" style="border:2px solid #000;border-radius:20px"><tbody><tr><td align="center"><table align="center" border="0" cellpadding="0" cellspacing="0" class="col-550" width="800"><tbody><tr style="background-color:#008ec4"><td align="center" style="border-top-right-radius:20px;border-top-left-radius:20px"><img src="https://i.imgur.com/U4gwHUE.png" alt="logo" height="85px" width="auto" style="padding-top:6px;padding-bottom:3px"><a href="#" style="text-decoration:none"><p style="color:#fff;font-weight:700;font-size:30px;font-family:Lucida Sans\',\'Lucida Sans Regular\',\'Lucida Grande\',\'Lucida Sans Unicode\',Geneva,Verdana,sans-serif;margin:auto;padding-bottom:6px">Welcome to ShumiShumi!</p></a></td></tr></tbody></table></td></tr><tr style="height:300px"><td align="center" style="border:none;border-bottom:2px solid #eceffb;padding-top:5px;padding-right:5px;padding-left:5px;border-bottom-left-radius:20px;border-bottom-right-radius:20px"><p style="margin:auto;font-family:sans-serif;font-weight:bolder;font-size:30px;letter-spacing:.025em;color:#000">Hello %s!</p><p style="font-family:sans-serif;text-align:left;font-weight:semibold;font-size:18px;letter-spacing:.025em;color:#000;padding-inline:35px">Thank you for choosing <span style="font-weight:700">ShumiShumi</span>!<br><br>To continue the verification process, please use the following code below on the ShumiShumi website:</p><table align="center" border="0" cellpadding="0" cellspacing="0" width="200" bgcolor="white"><tbody><tr><td align="center" style="background-color:#00a9ea;height:50px;border-radius:10px"><p style="font-family:\'Lucida Sans\',\'Lucida Sans Regular\',\'Lucida Grande\',\'Lucida Sans Unicode\',Geneva,Verdana,sans-serif;font-weight:bolder;font-size:25px;letter-spacing:.025em;color:#000">%s</p></td></tr></tbody></table><p style="font-family:sans-serif;text-align:left;padding-inline:35px;font-weight:semibold;font-size:15px;letter-spacing:.025em;color:#000">If you didn\'t request this, you can simply ignore this email or let us know. Thanks!<br><br>Best Regards,<br>ShumiShumi Teams</p><hr><p style="margin:auto;text-align:left;padding-inline:35px;color:gray;padding-bottom:8px">ShumiShumi Application<br>Indonesia</p></td></tr></tbody></table></body>'
    ),
    (
        "RESET_PASSWORD_EMAIL",
        '<body style="background-color:#d8dee9"><table align="center" border="0" cellpadding="0" cellspacing="0" width="800" bgcolor="white" style="border:2px solid #000;border-radius:20px"><tbody><tr><td align="center"><table align="center" border="0" cellpadding="0" cellspacing="0" class="col-550" width="800"><tbody><tr style="background-color:#008ec4"><td align="center" style="border-top-right-radius:20px;border-top-left-radius:20px"><img src="https://i.imgur.com/U4gwHUE.png" alt="logo" height="85px" width="auto" style="padding-top:6px;padding-bottom:3px"><a href="#" style="text-decoration:none"><p style="color:#fff;font-weight:700;font-size:27px;font-family:\'Lucida Sans\',\'Lucida Sans Regular\',\'Lucida Grande\',\'Lucida Sans Unicode\',Geneva,Verdana,sans-serif;margin:auto;padding-bottom:6px">You have requested to reset your password!</p></a></td></tr></tbody></table></td></tr><tr style="height:300px"><td align="center" style="border:none;border-bottom:2px solid #eceffb;padding-top:5px;padding-right:5px;padding-left:5px;border-bottom-left-radius:20px;border-bottom-right-radius:20px"><p style="margin:auto;font-family:sans-serif;font-weight:bolder;font-size:30px;letter-spacing:.025em;color:#000">Hello %s!</p><p style="font-family:sans-serif;text-align:left;font-weight:semibold;font-size:18px;letter-spacing:.025em;color:#000;padding-inline:35px">It seems that you have forgotten your password for your<span style="font-weight:700">ShumiShumi</span>\'s account<br><br>To reset your password, please follow the link that we have provided below:</p><table align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="white"><tbody><tr><td align="center" style="height:50px;border-radius:10px"><p style="font-family:Verdana,Geneva,Tahoma,sans-serif;font-weight:200;font-size:14px;color:#00f">[RESET PASSWORD URL HERE]</p></td></tr></tbody></table><p style="font-family:sans-serif;text-align:left;padding-inline:35px;font-weight:semibold;font-size:15px;letter-spacing:.025em;color:#000">If you didn\'t request this, you can simply ignore this email or let us know. Thanks!<br><br>Best Regards,<br>ShumiShumi Teams</p><hr><p style="margin:auto;text-align:left;padding-inline:35px;color:gray;padding-bottom:8px">ShumiShumi Application<br>Indonesia</p></td></tr></tbody></table></body>'
    );
